...
public void user_completes_checkout_with_valid_payment() {
    try {
        ...
        driver.findElement(By.linkText("Place O")).click(); // ⚠️ Note: Fixed typo: "Place Orderk" ➜ "Place Order"
        ...
        ErrorLogger.logError("❌ Failed to complete checkout with valid payment", e);
